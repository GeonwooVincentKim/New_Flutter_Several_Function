      ...
      builder: (ctx, product, child) => (
          Stack(
            ...
            Align(
              ...
              child: IconButton(
                icon: Icon( isFavorite ? IconMoon.istarfull : IconMoon.istar, color: Colors.white, ),
                onPressed: () {
...
class ProgressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        LinearProgressIndicator( minHeight: 10, backgroundColor: Colors.grey, value: gameProgressBar / 100 ),
      ],
    );
  }
}